 ...
 */
package com.lundellnet.toolbox.obj.parsers.generators;
...
public interface ElementCollectionGenerator <C extends DataElementCollection<R, E>, E extends ConfigurableDataAccess<?>, R>{
	C generate();
}
